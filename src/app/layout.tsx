...
export const metadata: Metadata = {
  metadataBase: new URL("https://grade-calculator-smoky.vercel.app"),
  title: {
    default: "Grade Calculator - Free Online Grade & GPA Calculator Tools",
    template: "%s | Grade Calculator"
  },
  description: "Free comprehensive grade calculator tools for students and educators. Calculate weighted averages, final exam grades, GPA, SGPA to CGPA, CGPA to percentage, percentage to SGPA conversion, marks percentage, and more. Easy-to-use online calculators with instant results.",
  keywords: [
    "grade calculator",
    "GPA calculator",
  ...
  openGraph: {
    ...
    description: "Free comprehensive grade calculator tools for students and educators. Calculate weighted averages, final exam grades, GPA, SGPA to CGPA conversion, and more.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const structuredData = {
    ...
    "description": "Free comprehensive grade calculator tools for students and educators",
    "url": "https://grade-calculator-smoky.vercel.app",
